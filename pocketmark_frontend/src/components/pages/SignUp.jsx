...
const click = ()=>{
    ...
    axios.post(`http://localhost:9090/api/sign-up`,{id:`${id.value}`,pw:`${pw.value}`,email:`${email.value}`})
    .then((res)=>{
        console.log(res);
    })
...
export default function SignIn(){
    return(
        <div className="sign-container">
            ...
            <input autoComplete="off" type='text' id="pw"  name="pw" placeholder="사용하실 비밀번호를 입력해주세요" className="sign-input"></input>
